...
package robotlegs.bender.extensions.viewProcessorMap.impl
{
	...
	public class ViewProcessorMap implements IViewProcessorMap, IViewHandler
	{
		...
		{
			_handler = handler ? handler : new ViewProcessorViewHandler(factory);
		}
		...
		{
			var mapper : IViewProcessorUnmapper = _mappers[matcher.createTypeFilter().descriptor];
			return mapper ? mapper : NULL_UNMAPPER;
		}
